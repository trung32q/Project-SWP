 ...
 * @author tieup
 */
public class Confim_ForgetServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String enter_captcha = request.getParameter("enter_captcha");
        HttpSession session = request.getSession();
        String captcha = (String) session.getAttribute("captcha");
        if(captcha.equals(enter_captcha)){
            request.setAttribute("email", email);
            request.getRequestDispatcher("setPassword.jsp").forward(request, response);
            
        }else{
            request.setAttribute("notification", "Wrong Catpcha");
            request.setAttribute("email", email);
